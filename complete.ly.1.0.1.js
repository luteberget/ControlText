        ...
        var p = {
            ...
            refresh : function(token, array) {
                ...
                for (var i=0;i<array.length;i++) {
                    ...
                    divRow.onmouseover = (function(rowIndex) { return function() { console.log("MOUSEOVER ROW" + rowIndex + "-" + ix); p.move(rowIndex-ix); txtHint.value = leftSide + array[i]; }; })(i);
                    //divRow.onmouseover = function() { p.move() }; 
